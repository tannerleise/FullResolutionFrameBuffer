// FrameBuffer_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module FrameBuffer_mm_interconnect_0 (
		...
		input  wire [29:0] dma_0_control_port_slave_readdata,              //                                         .readdata
		output wire [29:0] dma_0_control_port_slave_writedata,             //                                         .writedata
	...
	wire  [101:0] rsp_mux_001_src_data;                                                 // rsp_mux_001:src_data -> dma_0_read_master_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                // dma_0_read_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                              // rsp_mux_001:src_channel -> dma_0_read_master_agent:rp_channel
	...
	wire  [102:0] dma_0_control_port_slave_agent_rf_source_data;                        // dma_0_control_port_slave_agent:rf_source_data -> dma_0_control_port_slave_agent_rsp_fifo:in_data
	...
	wire  [102:0] dma_0_control_port_slave_agent_rsp_fifo_out_data;                     // dma_0_control_port_slave_agent_rsp_fifo:out_data -> dma_0_control_port_slave_agent:rf_sink_data
	...
	wire          cmd_mux_src_valid;                                                    // cmd_mux:src_valid -> dma_0_control_port_slave_agent:cp_valid
	wire  [101:0] cmd_mux_src_data;                                                     // cmd_mux:src_data -> dma_0_control_port_slave_agent:cp_data
	wire          cmd_mux_src_ready;                                                    // dma_0_control_port_slave_agent:cp_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                  // cmd_mux:src_channel -> dma_0_control_port_slave_agent:cp_channel
	wire          cmd_mux_src_startofpacket;                                            // cmd_mux:src_startofpacket -> dma_0_control_port_slave_agent:cp_startofpacket
	wire          cmd_mux_src_endofpacket;                                              // cmd_mux:src_endofpacket -> dma_0_control_port_slave_agent:cp_endofpacket
	...
	wire  [101:0] dma_0_read_master_agent_cp_data;                                      // dma_0_read_master_agent:cp_data -> router_001:sink_data
	...
	wire  [101:0] dma_0_control_port_slave_agent_rp_data;                               // dma_0_control_port_slave_agent:rp_data -> router_002:sink_data
	...
	wire   [83:0] new_sdram_controller_0_s1_agent_rp_data;                              // new_sdram_controller_0_s1_agent:rp_data -> router_003:sink_data
	...
	wire   [83:0] router_003_src_data;                                                  // router_003:src_data -> new_sdram_controller_0_s1_rsp_width_adapter:in_data
	...
	wire  [101:0] new_sdram_controller_0_s1_rsp_width_adapter_src_data;                 // new_sdram_controller_0_s1_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	...
	wire  [101:0] cmd_mux_001_src_data;                                                 // cmd_mux_001:src_data -> new_sdram_controller_0_s1_cmd_width_adapter:in_data
	...
	FrameBuffer_mm_interconnect_0_router router (
	...
	FrameBuffer_mm_interconnect_0_router_001 router_001 (
	...
	FrameBuffer_mm_interconnect_0_router_002 router_002 (
	...
	FrameBuffer_mm_interconnect_0_router_003 router_003 (
	...
	FrameBuffer_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (pll_0_outclk0_clk),                             //        clk.clk
		.reset              (dma_0_reset_reset_bridge_in_reset_reset),       //  clk_reset.reset
	...
	FrameBuffer_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (pll_0_outclk0_clk),                       //       clk.clk
		.reset              (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	FrameBuffer_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (pll_0_outclk0_clk),                       //       clk.clk
		.reset               (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	FrameBuffer_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (pll_0_outclk0_clk),                       //       clk.clk
		.reset               (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	FrameBuffer_mm_interconnect_0_cmd_demux_001 rsp_demux (
		.clk                (pll_0_outclk0_clk),                       //       clk.clk
		.reset              (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	FrameBuffer_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (pll_0_outclk0_clk),                                             //       clk.clk
		.reset              (dma_0_reset_reset_bridge_in_reset_reset),                       // clk_reset.reset
	...
	FrameBuffer_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (pll_0_outclk0_clk),                       //       clk.clk
		.reset               (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	FrameBuffer_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (pll_0_outclk0_clk),                       //       clk.clk
		.reset               (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	FrameBuffer_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	FrameBuffer_mm_interconnect_0_avalon_st_adapter_001 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
